...
This project is a modified version of [@jofr/capacitor-media-session](https://github.com/jofr/capacitor-media-session), originally developed by [@jofr](https://github.com/jofr), licensed under the GNU General Public License v3.0.
This fork adds support for the latest version of Capacitor (Capacitor 7) and adapts the plugin for more modern app setups.
This fork continues to be licensed under **GPL-3.0**. See the [LICENSE](./LICENSE) file for details.
